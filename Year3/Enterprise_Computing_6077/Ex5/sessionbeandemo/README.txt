...
a persistence unit "sessionbeandemoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "sessionbeandemo/pom.xml":
...
artifact ("sessionbeandemo.war") is already built. You can build
