...
a persistence unit "mdbdemoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "mdbdemo/pom.xml":
...
artifact ("mdbdemo.war") is already built. You can build
